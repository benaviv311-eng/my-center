(function(root,factory){
  ...
  const COACH_FEED_CARDS=[
    {id:'sp-1',topic:'sport-psychology',type:'concept',title:'מסוגלות עצמית',body:'ביטחון יציב נבנה מחוויות הצלחה שהשחקן יודע לשייך ליכולת שלו.',application:'בכדורעף: בנה שתי הצלחות מדידות לפני העלאת רמת הקושי.',source:'ספריית הלמידה — מסוגלות עצמית',sourceKind:'summary',tags:['ביטחון']},
    ...
    {id:'cp-2',topic:'coaching-psychology',type:'scenario',title:'שאלה לפני פתרון',body:'לפני שאתה אומר מה השתבש, שאל שאלה קצרה שמכוונת את השחקן לזהות את הבעיה.',application:'נסה: מה ראית לפני המגע? או איפה הייתה המטרה שלך?',tags:['למידה']},
    ...
    {id:'mp-1',topic:'movement-psychology',type:'concept',title:'מיקוד חיצוני',body:'לעיתים יעיל יותר לכוון את הקשב להשפעת התנועה על הכדור או המטרה ולא לכל איבר בגוף.',application:'במקום יישר מרפקים, נסה שלח את הכדור במסלול נמוך אל המוסר.',tags:['External Focus']},
    ...
    {id:'cl-1',topic:'coaching-language',type:'language',title:'משפט אחד לחזרה אחת',body:'Cue אחד מאפשר ניסיון ברור ומשוב ברור יותר מעודף הוראות.',application:'לפני סרב בחר מסר אחד, למשל מטרה עמוקה 1, ורק אחרי החזרה הוסף מידע.',tags:['Cue']},
    {id:'cl-2',topic:'coaching-language',type:'application',title:'אחרי טעות: תאר את הפעולה הבאה',body:'שפה יעילה אחרי טעות מתארת מה לעשות עכשיו יותר מאשר מה אסור שיקרה שוב.',application:'במקום אל תברחי מהכדור, נסה צעד ראשון לכיוון הכדור והישארי מאחוריו.',tags:['ניסוח']},
    ...
    {id:'va-1',topic:'volleyball-approaches',type:'concept',title:'Game-Based: שמור את הבעיה בתוך התרגיל',body:'אפשר לבנות משחקון קטן שבו הבעיה הטקטית אמיתית אבל התנאים פשוטים יותר.',application:'כדי לעבוד על קבלה והתקפה, שחק 3 על 3 עם ניקוד כפול על Side-Out אחרי קבלה לא מושלמת.',tags:['Game-Based']},
